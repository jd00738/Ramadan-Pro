...
class QuranCustomAdaptor(private val context: Activity, private val dua_name:Array<String>,private val dua_arabic:Array<String>,private val dua_english: Array<String>,private val dua_urdu:Array<String>):
    ...
    override fun getView(position: Int, view: View?, paremt: ViewGroup): View {
        ...
        val rowView = inflater.inflate(R.layout.custom_activity_quran, null, true)
